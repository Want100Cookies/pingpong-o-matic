...
module DE2_115_QSYS_mm_interconnect_0 (
	...
	wire  [14:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_qsys_data_master_agent:rp_channel
	...
	wire  [14:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_qsys_instruction_master_agent:rp_channel
	...
	wire  [14:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> lcd_0_control_slave_agent:cp_channel
	...
	wire  [14:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> nios2_qsys_debug_mem_slave_agent:cp_channel
	...
	wire  [14:0] cmd_mux_004_src_channel;                                                          // cmd_mux_004:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> ledg_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> sw_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_009_src_channel;                                                          // cmd_mux_009:src_channel -> sevseg_0_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_010_src_channel;                                                          // cmd_mux_010:src_channel -> sevseg_1_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_011_src_channel;                                                          // cmd_mux_011:src_channel -> sevseg_2_s1_agent:cp_channel
	...
	wire  [14:0] cmd_mux_012_src_channel;                                                          // cmd_mux_012:src_channel -> ledr_s1_agent:cp_channel
	...
	wire  [19:0] score_a_s1_agent_m0_address;                                                      // score_a_s1_agent:m0_address -> score_a_s1_translator:uav_address
	...
	wire  [98:0] score_a_s1_agent_rf_source_data;                                                  // score_a_s1_agent:rf_source_data -> score_a_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] score_a_s1_agent_rsp_fifo_out_data;                                               // score_a_s1_agent_rsp_fifo:out_data -> score_a_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_013_src_data;                                                             // cmd_mux_013:src_data -> score_a_s1_agent:cp_data
	wire         cmd_mux_013_src_ready;                                                            // score_a_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire  [14:0] cmd_mux_013_src_channel;                                                          // cmd_mux_013:src_channel -> score_a_s1_agent:cp_channel
	...
	wire  [19:0] score_b_s1_agent_m0_address;                                                      // score_b_s1_agent:m0_address -> score_b_s1_translator:uav_address
	...
	wire  [98:0] score_b_s1_agent_rf_source_data;                                                  // score_b_s1_agent:rf_source_data -> score_b_s1_agent_rsp_fifo:in_data
	...
	wire  [98:0] score_b_s1_agent_rsp_fifo_out_data;                                               // score_b_s1_agent_rsp_fifo:out_data -> score_b_s1_agent:rf_sink_data
	...
	wire  [97:0] cmd_mux_014_src_data;                                                             // cmd_mux_014:src_data -> score_b_s1_agent:cp_data
	wire         cmd_mux_014_src_ready;                                                            // score_b_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire  [14:0] cmd_mux_014_src_channel;                                                          // cmd_mux_014:src_channel -> score_b_s1_agent:cp_channel
	...
	wire  [97:0] score_a_s1_agent_rp_data;                                                         // score_a_s1_agent:rp_data -> router_015:sink_data
	...
	wire  [97:0] score_b_s1_agent_rp_data;                                                         // score_b_s1_agent:rp_data -> router_016:sink_data
