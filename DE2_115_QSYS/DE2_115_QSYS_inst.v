	DE2_115_QSYS u0 (
		...
		.framebuffer_data_external_connection_export (<connected-to-framebuffer_data_external_connection_export>), // framebuffer_data_external_connection.export
		.framebuffer_clk_external_connection_export  (<connected-to-framebuffer_clk_external_connection_export>),  //  framebuffer_clk_external_connection.export
		.framebuffer_addr_external_connection_export (<connected-to-framebuffer_addr_external_connection_export>)  // framebuffer_addr_external_connection.export
	);
