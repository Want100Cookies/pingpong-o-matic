	DE2_115_QSYS u0 (
		...
		.camera_red_in_external_connection_export   (<connected-to-camera_red_in_external_connection_export>),   //   camera_red_in_external_connection.export
		.camera_green_in_external_connection_export (<connected-to-camera_green_in_external_connection_export>), // camera_green_in_external_connection.export
		.camera_blue_in_external_connection_export  (<connected-to-camera_blue_in_external_connection_export>)   //  camera_blue_in_external_connection.export
	);
